...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'mercurix', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'meow', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://michico.art', // 网站地址
  ...
  FONT_URL: [
    // 'https://npm.elemecdn.com/Microsoft-YaHei-webfont@1.6.0/style.css',
    'https://fonts.googleapis.com/css?family=Arial&display=swap',
    'https://fonts.googleapis.com/css2?family=Microsoft-YaHei:wght@300&display=swap',
    'https://fonts.googleapis.com/css2?family=Microsoft-YaHei:wght@300&display=swap'
  ],
